...
import com.javatechie.annotations.Init;
import com.javatechie.annotations.JsonElement;
import com.javatechie.annotations.JsonSerializer;
...
public class ObjectToJsonConvertor {
    ...
    private void checkIfSerializable(Object object) {
        ...
        if (!clazz.isAnnotationPresent(JsonSerializer.class)) {
            throw new JsonSerializationException("The Class" + clazz.getSimpleName() + "is not annotated with JsonSerializer");
        }
    }
